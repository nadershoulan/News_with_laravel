...
//        return $grouped_by;
        $all_header_slider = HeaderSlider::all()->groupBy('id');
        //HeaderSlider::all();
        $all_language = Language::all();
        return view('backend.pages.header.header')->with(['all_header_slider' => $all_header_slider,'all_language' => $all_language]);
    }
