                    ...
                    <div class="card-body">
                        ...
                        <form action="{{route('admin.general.site.identity')}}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                <label for="site_logo"><strong>{{__('Site website Logo')}}</strong></label>
                                <input type="file" name="site_logo"  class="form-control" id="site_logo">
                                <small class="form-text text-muted">{{__('allowed image format: jpg,jpeg,png. max image size 2MB')}}</small>
                            </div>
                            <div class="img-wrapper" style="margin: 20px;">
                            ...
                            <div class="form-group">
                                <label for="site_favicon">{{__('Favicon for dashboard')}}</label>
