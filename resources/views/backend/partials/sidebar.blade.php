                    ...
                    {{-- <li class="
                                                                {{active_menu('admin-home/blog')}}
                                                                        ...
                                                                        @if(request()->is('admin-home/blog-edit/*')) active @endif
                                                                                ">
                        <a href="javascript:void(0)" aria-expanded="true"><i class="ti-write"></i> <span>{{__('Reservation')}}</span></a>
                        <ul class="collapse">
                            <li class="{{active_menu('admin-home/Reservation')}}"><a href="{{route('admin.Reservation')}}">{{__('All Reservation')}}</a></li>
                            <li class="{{active_menu('admin-home/blog-category')}}"><a
                                    href="{{route('admin.blog.category')}}">{{__('Category')}}</a></li>
                            <li class="{{active_menu('admin-home/new-Reservation')}}"><a
                                    href="{{route('admin.Reservation.new')}}">{{__('Add New Reservation')}}</a></li>
                        </ul>
                    </li> --}}
                    @endif
                   @if('super_admin' == auth()->user()->role || 'admin' == auth()->user()->role || 'editor' == auth()->user()->role)
                    ...
                    {{active_menu('admin-home/blog')}}
                            ...
                            @if(request()->is('admin-home/blog-edit/*')) active @endif
                                    ">
                        <a href="javascript:void(0)" aria-expanded="true"><i class="ti-write"></i> <span>{{__('Chef')}}</span></a>
                        <ul class="collapse">
                            <li class="{{active_menu('admin-home/chef')}}"><a
                                    href="{{route('admin.chef')}}">{{__('All Chef')}}</a></li>
                    <li class="{{active_menu('admin-home/new-Chef')}}"><a
                            href="{{route('admin.chef.new')}}">{{__('Add New Chef')}}</a></li>
                    </ul>
                    </li> --}}
                    @endif
                    @if('super_admin' == auth()->user()->role || 'admin' == auth()->user()->role || 'editor' == auth()->user()->role)
                    ...
                    {{active_menu('admin-home/blog')}}
                            ...
                            @if(request()->is('admin-home/blog-edit/*')) active @endif
                                                                                                                        ">
                        <a href="javascript:void(0)" aria-expanded="true"><i class="ti-write"></i> <span>{{__('Upcomming events')}}</span></a>
                        <ul class="collapse">
                            <li class="{{active_menu('admin-home/upcomming_events')}}"><a href="{{route('admin.upcomming_events')}}">{{__('All upcomming_events')}}</a></li>
                            <li class="{{active_menu('admin-home/new-upcomming_events')}}"><a
                                    href="{{route('admin.upcomming_events.new')}}">{{__('Add New upcomming_events')}}</a></li>
                        </ul>
                    </li> --}}
                    @endif
                    <li>
                        ...
                        <ul class="collapse">
                            <li class="{{active_menu('admin-home/sign_up')}}"><a
                                    href="{{route('admin.sign_up')}}">{{__('All sign_up')}}</a></li>
                    ...
                    @endif
                    <li>
                        <a href="{{route('admin.comment')}}" aria-expanded="true"><i class="ti-write"></i>
                            <span>{{__('Comment')}}</span></a>
                    ...
                    {{-- <li class="
                                                                {{active_menu('admin-home/blog')}}
                                                                        ...
                                                                        @if(request()->is('admin-home/blog-edit/*')) active @endif
                                                                                ">
                        <a href="javascript:void(0)" aria-expanded="true"><i class="ti-write"></i> <span>{{__('Menu')}}</span></a>
                        <ul class="collapse">
                            <li class="{{active_menu('admin-home/menu')}}"><a href="{{route('admin.menu')}}">{{__('All Menu')}}</a></li>
                            <li class="{{active_menu('admin-home/menu-category')}}"><a
                                    href="{{route('admin.menu.category')}}">{{__('Menu Category')}}</a></li>
                            <li class="{{active_menu('admin-home/new-menu')}}"><a
                                    href="{{route('admin.menu.new')}}">{{__('Add New Menu')}}</a></li>
                        </ul>
                    </li> --}}
                    <li>
                        <a href="{{route('admin.ContactInfoItem')}}" aria-expanded="true"><i class="ti-write"></i>
                            <span>{{__('Contact_info_items')}}</span></a>

                    </li>
                    <li class="{{active_menu('admin-home/menu-about')}}"><a
                            href="{{route('admin.about.category')}}"><i class="ti-write"></i><span>{{__(' About me ')}}</span></a>
                        </li>
                        <li class="{{active_menu('admin-home/HeaderSlider-about')}}"><a href="{{route('admin.HeaderSlider.category')}}"><i
                                    class="ti-write"></i><span>{{__('Header Slider')}}</span></a>
                        </li>
                    @endif
                    @if('super_admin' == auth()->user()->role )
                    <li class="@if(request()->is('admin-home/general-settings/*')) active @endif">
                        ...
                        <ul class="collapse ">
                            ...
                            <li class="{{active_menu('admin-home/general-settings/basic-settings')}}"><a
                                    href="{{route('admin.general.basic.settings')}}">{{__('Basic Settings')}}</a></li>
                            {{-- <li class="{{active_menu('admin-home/general-settings/typography-settings')}}"><a
                                    href="{{route('admin.general.typography.settings')}}">{{__('Typography Settings')}}</a></li> --}}
                            ...
                            {{-- <li class="{{active_menu('admin-home/general-settings/scripts')}}"><a
                                    href="{{route('admin.general.scripts.settings')}}">{{__('Third Party Scripts')}}</a></li> --}}
                            {{-- <li class="{{active_menu('admin-home/general-settings/email-template')}}"><a
                                    href="{{route('admin.general.email.template')}}">{{__('Email Template')}}</a></li>
                            ...
                            <li class="{{active_menu('admin-home/general-settings/cache-settings')}}"><a
                                    href="{{route('admin.general.cache.settings')}}">{{__('Cache Settings')}}</a></li>
                            <li class="{{active_menu('admin-home/general-settings/backup-settings')}}"><a
                                    href="{{route('admin.general.backup.settings')}}">{{__('Backup Settings')}}</a></li>
                            <li class="{{active_menu('admin-home/general-settings/edit_words-settings')}}"><a
                                    href="{{route('admin.general.edit_words.settings')}}">{{__('Edit_words Settings')}}</a></li>
                            {{-- <li class="{{active_menu('admin-home/general-settings/license-setting')}}"><a
                                    href="{{route('admin.general.license.settings')}}">{{__('Licence Settings')}}</a></li> --}}
                        </ul>
                    </li>
                    <li  >
                        <a href="#" aria-expanded="true"><i class="ti-signal"></i>
                            <span>{{__(' ')}}</span></a>
                    </li>
...
--}}
                    ...
                    {{active_menu('admin-home/works')}}
                        ...
                        <ul class="collapse">
                            <li class="{{active_menu('admin-home/work')}}"><a href="{{route('admin.work')}}">{{__('New/All Works')}}</a></li>
